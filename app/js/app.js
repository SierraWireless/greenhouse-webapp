...
/* App Module */
angular.module('greenhouse', ['http-auth-interceptor','ngCookies','credentials'])
.run(['$rootScope','$http',"$cookies","authService","$credentials","$timeout", function($rootScope,$http,$cookies,$authService,$credentials,$timeout) {
